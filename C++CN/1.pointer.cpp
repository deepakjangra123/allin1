...
int main()
{
   ...
   cout << "Value of var :" << *x << endl;  // ERROR
...
int main()
{
   ...
   cout << p + 1 << endl; // 0x61ff10
   cout << p + 2 << endl; // 0x61ff10
   cout << p + 3 << endl; // 0x61ff10
   return 0;
}
...
int main()
{
   ...
   *p = 10;
   ...
   cout << numbers << endl; // 0x61fef8
                            // we can assign and address to a pointer or only we can point the pointer p to any location
